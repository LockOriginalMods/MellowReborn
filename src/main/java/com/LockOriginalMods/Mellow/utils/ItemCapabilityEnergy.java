...
public class ItemCapabilityEnergy implements ICapabilityProvider, IEnergyStorage {
    ...
    private final MellowEnergyStorage energyStorage;
    private final LazyOptional<IEnergyStorage> lazyEnergyStorage;

    public ItemCapabilityEnergy(ItemStack itemStack, @Nullable CompoundTag nbt, MellowEnergyStorage energyStorage) {
