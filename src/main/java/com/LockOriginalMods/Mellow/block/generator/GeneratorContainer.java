package com.LockOriginalMods.Mellow.block.generator;
...
import static com.LockOriginalMods.Mellow.block.generator.GeneratorBlockEntity.SLOT;
import static com.LockOriginalMods.Mellow.block.generator.GeneratorBlockEntity.SLOT_COUNT;
...
public class GeneratorContainer extends AbstractContainerMenu {
    ...
    public GeneratorContainer(int windowId, Player player, BlockPos pos) {
        super(Registry.GENERATOR_CONTAINER.get(), windowId);
        this.pos = pos;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(player.level(), pos), player, Registry.GENERATOR_BLOCK.get());
    }
}