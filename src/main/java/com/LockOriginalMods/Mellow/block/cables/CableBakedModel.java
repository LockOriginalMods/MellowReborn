...
import static com.LockOriginalMods.Mellow.block.cables.ConnectorType.NONE;
...
import static com.LockOriginalMods.Mellow.block.cables.BakedModelHelper.quad;
import static com.LockOriginalMods.Mellow.block.cables.BakedModelHelper.v;
import static com.LockOriginalMods.Mellow.block.cables.CablePatterns.SpriteIdx.*;
import static com.LockOriginalMods.Mellow.block.cables.ConnectorType.BLOCK;
import static com.LockOriginalMods.Mellow.block.cables.ConnectorType.CABLE;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    private TextureAtlasSprite getTexture(String path) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(MOD_ID, path));
    }
