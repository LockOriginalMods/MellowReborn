...
public class ElectricFurnaceRecipe implements Recipe<SimpleContainer> {
    ...
    public ElectricFurnaceRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<ElectricFurnaceRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(MOD_ID, "electric_furnace");
        ...
        @Override
        public @Nullable ElectricFurnaceRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new ElectricFurnaceRecipe(id, output, inputs);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buf, ElectricFurnaceRecipe recipe) {
